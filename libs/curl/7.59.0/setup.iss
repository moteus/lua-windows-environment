; ==========================================================================
; External dep - cURL 7.59.0
; ==========================================================================

#define protected CURL_VERSION "7.59.0"
#define protected CURL_VERSION_NAME "v7_59_0"
...
Name: "External\curl\{#CURL_VERSION_NAME}\sspi_idn"; Description: "DLL WinSSPI WinIDN"; Flags: exclusive;
...
; External dep - curl WinSSPI/WinIDN
Source: "{#ROOT}\libs\curl\{#CURL_VERSION}\{#ArchName}\{#RT}\DLL Release - DLL Windows SSPI - DLL WinIDN\curl.exe"; DestDir: "{app}\{#Arch}\external\bin"; Components: External\curl\{#CURL_VERSION_NAME}\sspi_idn
Source: "{#ROOT}\libs\curl\{#CURL_VERSION}\{#ArchName}\{#RT}\DLL Release - DLL Windows SSPI - DLL WinIDN\libcurl.dll"; DestDir: "{app}\{#Arch}\external\bin"; Components: External\curl\{#CURL_VERSION_NAME}\sspi_idn
Source: "{#ROOT}\libs\curl\{#CURL_VERSION}\{#ArchName}\{#RT}\DLL Release - DLL Windows SSPI - DLL WinIDN\libcurl.lib"; DestDir: "{app}\{#Arch}\external\lib"; Components: External\curl\{#CURL_VERSION_NAME}\sspi_idn
